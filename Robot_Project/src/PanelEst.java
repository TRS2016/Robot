...
public class PanelEst {
	...
	public void nettoyerToutDroit(Monde m){
	...
	public void nettoyerLibre(Monde m){
	...
	public void nettoyerSauteur(Monde m){
	...
	public void MAS(Monde m){
		RobotPollueurSmart PC = new RobotPollueurSmart(m); 
		for(int i=0; i<10; i++)
			for(int j=0; j<10; j++){
				if(m.Mat[i][j])
